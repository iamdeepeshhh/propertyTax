...
public class PropertyDetails_Dto {
    ...
    private List<UnitDetails_Dto> unitDetails = new ArrayList<>();

    public PropertyDetails_Dto() {
    }

    public PropertyDetails_Dto(String pdNewpropertynoVc, String pdZoneI, String pdWardI, String pdSurypropnoVc,
